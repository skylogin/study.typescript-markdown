...
class HtmlHandler {
    ...
    private RenderHtmlContent(markdown: HTMLTextAreaElement, markdownOutput: HTMLLabelElement){
        if(markdown.value){
            console.log(markdown.value, " / ", this.markdownChange.ToHtml(markdown.value));
...
interface IVisitable{
    Accept(visitor: IVisitor, token: ParseElement, markdownDocumnet: IMarkdownDocument) : void;
}
